...
#' Add text annotation to stackedbar
#'
#' Use this function to place text at any point on a stackedbar. This
#' is especially useful for non-interactive stackedbars (i.e. to label
#' a particular stream).
#'
