#' Create a new normalized stacked barchart
#'
#' \code{stackedbarnormal()} initializes the stackedbar html widget
...
#' }
stackedbarnormal <- function(data,
                        key,
                        value,
                        date,
